CREATE TABLE planetary_rings (
                                 ...
                                 planetary_ring_system_id BIGINT NOT NULL REFERENCES planetary_ring_systems(id) ON DELETE CASCADE,
                                 ...
                                 UNIQUE(planetary_ring_system_id, ring_index)
);

CREATE INDEX idx_rings_planet ON planetary_rings(planetary_ring_system_id);
